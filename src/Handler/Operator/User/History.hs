...
module Handler.Operator.User.History where
...
-- TODO: FIXME: Generalize this module with user's profile handler

getOperatorUserHistoryR :: UserId -> Handler Html
getOperatorUserHistoryR clientId = do
    requireOperatorId
